...
public class CreateVisibleSignature extends CreateSignatureBase
{
     ...
     * @param out The file to be signed.
     * @throws IOException
     */
    public void signPDF(File inputFile, OutputStream out) throws IOException
    {
...
//        FileOutputStream fos = new FileOutputStream("test1.pdf");
        ...
        signature.setName("Anand Vaidya");
