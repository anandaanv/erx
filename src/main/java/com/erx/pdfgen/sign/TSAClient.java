...
public class TSAClient
{
    ...
    {
        TimeStampToken token = getTimeStampTokenTS(messageImprint);

        return token.getEncoded();
    }

	public TimeStampToken getTimeStampTokenTS(byte[] messageImprint) throws IOException {
		TimeStampResponse response = getTSResponse(messageImprint);
	...
	public TimeStampResponse getTSResponse(byte[] messageImprint) throws IOException {
		digest.reset();
